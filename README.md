...
Compatibility: webtrees 2.2.x <br>
There is a simple patch available for use with previous versions of webtrees.
...
> [!Caution]
> *this will overwrite any previously saved content.* See [Backup Section](#backup) below
